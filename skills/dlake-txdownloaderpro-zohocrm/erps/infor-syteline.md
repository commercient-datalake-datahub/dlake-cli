...
`dlake-txdownloaderpro-zohocrm/erps/infor-syteline.md`, and that skill’s ERP table is what
points at it.
...
- **Template names the catalogue carries:** `Create Contact` (1), `Create Customer` (1), `create
  Estimate` (1), `Create Products` (1), `Update Contact` (1), `Update Customer` (1), `Update
  Estimate` (1), `Update Product` (1).
- **Field-process versions they belong to:** `TxDownloader_32_1`, `TxDownloader_32_9`,
  `TxDownloader_32_4`, `TxDownloader_32_6`, `TxDownloader_32_12`, `TxDownloader_32_10`.
