...
`dlake-txdownloaderpro-zohocrm/erps/netsuite.md`, and that skill’s ERP table is what points at
it.
...
- **Template names the catalogue carries:** `Create New Contact` (3), `Create New Customer` (3),
  `Update Contact` (2), `Update Customer` (2), `Create New Sales Order` (1).
