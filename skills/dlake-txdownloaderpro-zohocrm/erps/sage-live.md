...
|---|---|---|---|---|
| TxDownloader_4_1 | Zoho Account to SageLive Customer | `Accounts` → `Customer` | 2 | create / update |
...
- **Response fields it reads them from:** `accountnumber`. The map is written **source-path
