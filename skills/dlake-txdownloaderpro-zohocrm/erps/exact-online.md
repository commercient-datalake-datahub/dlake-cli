---
name: dlake-txdownloaderpro-zohocrm/erps/exact-online
description: >-
  The catalogue ships no default TxDownloaderPro template for the pair where Zoho CRM is the
  writeback destination and Exact Online is the source. It does carry 1 community template for
...
# TxDownloaderPro ← Zoho CRM — Exact Online: no default templates, and the community set the catalogue carries
...
`dlake-txdownloaderpro-zohocrm/erps/exact-online.md`, and that skill’s ERP table is what points
at it.
...
- **Template names the catalogue carries:** `New Customer` (1).
- **Field-process versions they belong to:** `TxDownloaderPro_131_1`.
