...
description: >-
  ...
  destination and Microsoft Business Central is the source: the 5 default templates the
  catalogue ships for this pair, the 3 field-process versions they are identified by, what each
...
Across the 5 default templates: 2 carry `IsInsert`, 2 carry `IsUpdate`, 1 carries `IsDelete`. A
...
`TxDownloaderPro_121_8`, `TxDownloaderPro_121_10`.
...
- **Response fields it reads them from:** `number`. The map is written **source-path first,
