---
name: dlake-txdownloaderpro-zohocrm/erps/microsoft-dynamics-nav
description: >-
  What the shipped default TxDownloaderPro templates set up when Zoho CRM is the writeback
  destination and Microsoft Dynamics NAV is the source: the 2 default templates the catalogue
...
# TxDownloaderPro ← Zoho CRM — Microsoft Dynamics NAV: what the shipped default templates set up
...
`dlake-txdownloaderpro-zohocrm/erps/microsoft-dynamics-nav.md`, and that skill’s ERP table is
what points at it.
...
The field-process versions this pair’s default templates belong to: `TxDownloaderPro_35_3`.
...
- **Response fields it reads them from:** `No`. The map is written **source-path first,
