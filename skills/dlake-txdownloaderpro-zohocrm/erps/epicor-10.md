...
# TxDownloaderPro ← Zoho CRM — Epicor 10: what the shipped default templates set up
...
`dlake-txdownloaderpro-zohocrm/erps/epicor-10.md`, and that skill’s ERP table is what points at
it.
...
- **Template names the catalogue carries:** `Create New Contact` (1), `Create New Customer` (1),
  `Create Updated Quote` (1).
- **Field-process versions they belong to:** `TxDownloader_19_2`, `TxDownloader_19_1`,
  `TxDownloader_19_7`.
