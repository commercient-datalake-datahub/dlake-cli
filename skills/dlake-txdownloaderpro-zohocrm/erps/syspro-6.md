...
- **How many:** 6 community templates, across 2 field-process versions.
...
- **Template names the catalogue carries:** `Create Customer` (1), `New Sales Order` (1).
- **Names not reproduced:** 4 of these templates carry a name that is not a product artefact
  name, and it is not printed here.
- **Field-process versions they belong to:** `TxDownloaderPro_6_1`, `TxDownloaderPro_6_2`.
