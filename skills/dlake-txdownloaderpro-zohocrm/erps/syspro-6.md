...
description: >-
  ...
  destination and SYSPRO 6 is the source: the 2 default templates the catalogue ships for this
...
# TxDownloaderPro ← Zoho CRM — SYSPRO 6: what the shipped default templates set up
...
`dlake-txdownloaderpro-zohocrm/erps/syspro-6.md`, and that skill’s ERP table is what points at
it.
