---
name: dlake-txdownloaderpro-salesforce/erps/infor-visual-9
description: >-
  The catalogue ships no default TxDownloaderPro template for the pair where Salesforce is the
  writeback destination and Infor Visual 9 is the source. It does carry 3 community templates
  for the pair, across 3 field-process versions, and this page lists them: how many there are,
...
# TxDownloaderPro ← Salesforce — Infor Visual 9: no default templates, and the community set the catalogue carries
...
`dlake-txdownloaderpro-salesforce/erps/infor-visual-9.md`, and that skill’s ERP table is what
points at it.
...
- **Template names the catalogue carries:** `Create New Contact` (1), `Create New Customer` (1),
  `Create New Sales Orders` (1).
- **Field-process versions they belong to:** `TxDownloaderPro_38_2`, `TxDownloaderPro_38_1`,
  `TxDownloaderPro_38_3`.
