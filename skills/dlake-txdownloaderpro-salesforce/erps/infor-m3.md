---
name: dlake-txdownloaderpro-salesforce/erps/infor-m3
description: >-
  The catalogue ships no default TxDownloaderPro template for the pair where Salesforce is the
  writeback destination and Infor M3 is the source. It does carry 1 community template for the
...
# TxDownloaderPro ← Salesforce — Infor M3: no default templates, and the community set the catalogue carries
...
`dlake-txdownloaderpro-salesforce/erps/infor-m3.md`, and that skill’s ERP table is what points
at it.
...
- **Template names the catalogue carries:** `Create Customer` (1).
- **Field-process versions they belong to:** `TxDownloaderPro_127_1`.
