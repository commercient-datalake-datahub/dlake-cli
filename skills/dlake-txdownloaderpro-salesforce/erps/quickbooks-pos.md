---
name: dlake-txdownloaderpro-salesforce/erps/quickbooks-pos
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and QuickBooks POS is the source: the 1 default template the catalogue ships for
...
# TxDownloaderPro ← Salesforce — QuickBooks POS: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/quickbooks-pos.md`, and that skill’s ERP table is what
points at it.
...
The field-process versions this pair’s default templates belong to: `TxDownloader_24_1`.
