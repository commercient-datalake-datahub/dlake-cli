---
name: dlake-txdownloaderpro-salesforce/erps/infor10-distribution-business
description: >-
...
# TxDownloaderPro ← Salesforce — Infor10 Distribution Business: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/infor10-distribution-business.md`, and that skill’s ERP
...
|---|---|---|---|---|
| Create Customer in INFOR10DISTRIBUTIONBUSINESS | Salesforce Account to Infor 10 Distribution Business Customer | `Account` → `Customer` | 1 | create |
