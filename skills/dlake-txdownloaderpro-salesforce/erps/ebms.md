---
name: dlake-txdownloaderpro-salesforce/erps/ebms
description: >-
...
# TxDownloaderPro ← Salesforce — EBMS: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/ebms.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| TxDownloaderPro_146_1_1 | Salesforce Account to EBMS Customer | `Account` → `Customer` | 2 | create / update |
| TxDownloaderPro_146_2_1 | Salesforce Opportunity to EBMS Sales Order | `Opportunity` → `ARINV` | 2 | create / update |
| TxDownloaderPro_146_3_1 | Salesforce Contact to EBMS Contact | `Contact` → `ARCONTACTS` | 2 | create / update |
...
- **Template path roots used:** `Account`, `Contact`, `Opportunity`, `OpportunityLineItems`. A
