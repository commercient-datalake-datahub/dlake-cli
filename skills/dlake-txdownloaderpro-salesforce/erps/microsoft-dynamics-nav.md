...
description: >-
  ...
  parts the templates fill for the write back to the CRM. It also lists the 49 community
...
`dlake-txdownloaderpro-salesforce/erps/microsoft-dynamics-nav.md`, and that skill’s ERP table is
what points at it.
...
- **How many:** 49 community templates, across 11 field-process versions.
- **Operations:** 25 carry `IsInsert`, 24 carry `IsUpdate`, 0 carry `IsDelete`. A flag decides
...
- **Template names the catalogue carries:** `Create Contact Card` (2), `Create New Blanket
  Order` (2), `Create New Customer` (2), `Create New Customer Comment` (2), `Create New
  Opportunity` (2), `Create New Order Comment` (2), `Create New Quote` (2), `Create New RMA`
  (2), `Create New Sales Order` (2), `Create New ShipTo Address` (2), `Create New Tracking Line`
  (2), `Create SalesOrder from Salesforce` (2), `Update Blanket Order` (2), `Update Contact`
  (2), `Update Customer` (2), `Update Customer Comment` (2), `Update Opportunity` (2), `Update
  Order Comment` (2), `Update Quote` (2), `Update RMA` (2), `Update Sales Order` (2), `Update
  Ship To Address` (2), `Update Tracking Line` (2), `Create Contact card` (1), and 2 more.
- **Field-process versions they belong to:** `TxDownloaderPro_35_11`, `TxDownloaderPro_35_1`,
  `TxDownloaderPro_35_3`, `TxDownloaderPro_35_7`, `TxDownloaderPro_35_9`,
  `TxDownloaderPro_35_5`, `TxDownloaderPro_35_8`, `TxDownloaderPro_35_6`,
  `TxDownloaderPro_35_2`, `TxDownloaderPro_35_4`, `TxDownloaderPro_35_10`.
