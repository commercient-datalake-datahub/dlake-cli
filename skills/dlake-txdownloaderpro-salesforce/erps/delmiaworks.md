---
name: dlake-txdownloaderpro-salesforce/erps/delmiaworks
description: >-
...
# TxDownloaderPro ← Salesforce — DELMIAworks: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/delmiaworks.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| Create Sales Order | Salesforce Order to DELMIAWorks Sales Order | `Order` → `Sales Order` | 1 | create |
