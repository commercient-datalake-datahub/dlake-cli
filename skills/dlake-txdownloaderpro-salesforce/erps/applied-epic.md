---
name: dlake-txdownloaderpro-salesforce/erps/applied-epic
description: >-
...
# TxDownloaderPro ← Salesforce — Applied Epic: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/applied-epic.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| Create New Client | Salesforce Account to Applied Epic Client | `Account` → `Client` | 1 | create |
| Create New Contact | Salesforce Contact to Applied Epic Contact | `Contact` → `Contact` | 1 | create |
...
- **Template path roots used:** `Contact`, `Account`. A path’s first segment has to match the
