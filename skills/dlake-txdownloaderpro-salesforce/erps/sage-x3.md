---
name: dlake-txdownloaderpro-salesforce/erps/sage-x3
description: >-
...
# TxDownloaderPro ← Salesforce — Sage X3: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/sage-x3.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| CreateCustomer | Salesforce Account to SageX3 Customer | `Account` → `Customer` | 1 | create |
