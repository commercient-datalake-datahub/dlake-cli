---
name: dlake-txdownloaderpro-salesforce/erps/sap-business-bydesign
description: >-
...
# TxDownloaderPro ← Salesforce — SAP Business ByDesign: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/sap-business-bydesign.md`, and that skill’s ERP table is
what points at it.
...
|---|---|---|---|---|
| Create New Business Partner | Salesforce Account to SAP Business ByDesign Business Partner | `Account` → `Business Partner` | 2 | create / update |
| Create New Contact | Salesforce Account to SAP Business ByDesign Account | `Account` → `Account` | 2 | create / update |
| Create New Sales Order | Salesforce Order to SAP Business ByDesign Sales Order | `Order` → `Sales Order` | 2 | create / update |
