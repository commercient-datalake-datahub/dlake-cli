...
# TxDownloaderPro ← Salesforce — Sage 50 Canada: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/sage-50-canada.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| Create New Invoice | — | `Invoice`, `Order`, `Opportunity` → `Invoice` | 3 | create |
...
- **Template names the catalogue carries:** `Create New Contact` (2), `Create Customer` (1),
  `Create new` (1), `Create New Customer` (1), `Create New Invoice` (1), `Create New Product`
  (1), `Create Opportunity` (1).
- **Field-process versions they belong to:** `TxDownloader_18_7`, `TxDownloader_18_1`,
  `TxDownloader_18_2`, `TxDownloader_18_6`.
