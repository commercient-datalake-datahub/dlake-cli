---
name: dlake-txdownloaderpro-salesforce/erps/sage-businessworks-2013-2015
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and Sage BusinessWorks 2013/2015 is the source: the 1 default template the
...
# TxDownloaderPro ← Salesforce — Sage BusinessWorks 2013/2015: what the shipped default templates set up
...
`dlake-txdownloaderpro-salesforce/erps/sage-businessworks-2013-2015.md`, and that skill’s ERP
...
The field-process versions this pair’s default templates belong to: `TxDownloader_25_1`.
