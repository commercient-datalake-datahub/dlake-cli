---
name: dlake-txdownloaderpro-salesforce/erps/infor-ln-10
description: >-
  The catalogue ships no default TxDownloaderPro template for the pair where Salesforce is the
  writeback destination and Infor LN 10 is the source. It does carry 1 community template for
...
# TxDownloaderPro ← Salesforce — Infor LN 10: no default templates, and the community set the catalogue carries
...
`dlake-txdownloaderpro-salesforce/erps/infor-ln-10.md`, and that skill’s ERP table is what
points at it.
...
- **Operations:** 0 carry `IsInsert`, 1 carries `IsUpdate`, 0 carry `IsDelete`. A flag decides
...
- **Field-process versions they belong to:** `TxDownloaderPro_143_1`.
