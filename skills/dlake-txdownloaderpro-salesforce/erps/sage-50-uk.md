...
description: >-
  ...
  templates fill for the write back to the CRM. It also lists the 21 community templates the
...
- **How many:** 21 community templates, across 6 field-process versions.
- **Operations:** 14 carry `IsInsert`, 2 carry `IsUpdate`, 0 carry `IsDelete`. A flag decides
...
- **Template names the catalogue carries:** `Create New Customer` (6), `Create New Invoice` (3),
  `Create New Sales Order` (2), `New Account` (2), `New Sales Order` (2), `Create Invoice` (1),
  `Create Product Price` (1), `Create Product Price Quotes` (1), `New Contact` (1), `Update
  Customer` (1), `Update Invoice` (1).
- **Field-process versions they belong to:** `TxDownloader_3_6`, `TxDownloader_3_8`,
  `TxDownloader_3_3`, `TxDownloader_3_2`, `TxDownloader_3_1`, `TxDownloader_3_7`.
