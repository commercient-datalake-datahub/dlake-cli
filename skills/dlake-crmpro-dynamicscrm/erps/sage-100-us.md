...
description: >-
  ...
  they write are `CommercientSF8__CUSTOMERMATCHING__c`, `accounts`,
  `CommercientSF8__SAGE100_SALESORDERHISTORYDETAIL__c`, `CommercientSF8__SO_SALESORDERHEADER__c`,
  `CommercientSF8__SO_SHIPTOADDRESS__c` and more. Use it when deciding whether a shipped template
  set exists for a Sage 100 (US) → Dynamics CRM before standing one up, and what the community set
...
what this source's own templates set. This page is `dlake-crmpro-dynamicscrm/erps/sage-100-us.md`,
...
- Destination objects: `CommercientSF8__CUSTOMERMATCHING__c`, `accounts`, `CommercientSF8__SAGE100_SALESORDERHISTORYDETAIL__c`, `CommercientSF8__SO_SALESORDERHEADER__c`, `CommercientSF8__SO_SHIPTOADDRESS__c`, `comrcint_sage100_ar_customer`
- Object display names: SYNC CUSTOMERMATCHING, accounts, SalesOrder, SalesOrder History Line, Ship_TO_Address, Sync AR_CUSTOMER
...
adds what the Sage 100 (US) → Dynamics CRM template catalogue carries. `dlake-crmpro-dynamicscrm`
is the destination skill this page sits under: its own text is the authority for the Dynamics CRM
