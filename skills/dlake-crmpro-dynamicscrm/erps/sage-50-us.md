...
description: >-
  ...
  Standard template ships for this pair, and the 11 community templates it does carry are stated
  ...
  they write are `CommercientSF8__PRODUCT__c`, `account`, `CommercientSF8__CUSTOMER__c`,
  `CommercientSF8__SALESINVOICEDETAIL__c`, `CommercientSF8__SALESORDERDETAIL__c` and more. Use it
  when deciding whether a shipped template set exists for a Sage 50 US → Dynamics CRM before
...
what this source's own templates set. This page is `dlake-crmpro-dynamicscrm/erps/sage-50-us.md`,
...
- Destination objects: `CommercientSF8__PRODUCT__c`, `account`, `CommercientSF8__CUSTOMER__c`, `CommercientSF8__SALESINVOICEDETAIL__c`, `CommercientSF8__SALESORDERDETAIL__c`, `sage50us_address`, `sage50us_customer`, `sage50us_invoiceheader`, `sage50us_item`, `sage50us_salesorder`
- Object display names: SYNC PRODUCT, Get Accounts, Sage50 US Sales Invoice Detail, Sage50 US Sales Order Detail, sage50us address, sage50us customer, sage50us invoiceheader, sage50us item, sage50us salesorder, SYNC CUSTOMER
...
adds what the Sage 50 US → Dynamics CRM template catalogue carries. `dlake-crmpro-dynamicscrm` is
