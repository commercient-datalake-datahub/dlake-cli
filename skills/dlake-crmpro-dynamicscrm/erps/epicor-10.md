...
description: >-
  What the shipped CRMPro templates set up for an Epicor 10 source pushing into Dynamics CRM: the
  ...
  Invoice and more. Use it when standing up or reading an Epicor 10 → Dynamics CRM template set,
  ...
  covers operating CRMPro generally, and `dlake-crmpro-dynamicscrm`, the destination skill this
...
--crmName DynamicCRM` — but the product is Dynamics CRM, which is what this page calls it. What
