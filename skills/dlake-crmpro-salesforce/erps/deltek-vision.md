...
this source's own templates set. This page is `dlake-crmpro-salesforce/erps/deltek-vision.md`, and
that skill's ERP table is what points at it. What follows is only what the shipped Deltek Vision →
...
adds what the shipped Deltek Vision → Salesforce templates set up. `dlake-crmpro-salesforce` is
