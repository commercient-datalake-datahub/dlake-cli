---
name: dlake-crmpro-salesforce/erps/sage-100-us
description: >-
  What the shipped CRMPro templates set up for a Sage 100 (US) source pushing into Salesforce: the
  ...
  Sage 100 (US) → Salesforce template set, when deciding which templates to import and activate,
...
The catalogue carries 1310 community templates for this pair. A community template is authored in
a tenant rather than shipped with the product, and it imports the same way as any other. Its own
