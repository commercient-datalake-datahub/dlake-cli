---
name: dlake-txdownloaderpro-dynamicscrm/erps/sage-100-contractor
description: >-
  What the shipped default TxDownloaderPro templates set up when Dynamics CRM is the writeback
  destination and Sage 100 Contractor is the source: the 4 default templates the catalogue ships
...
# TxDownloaderPro ← Dynamics CRM — Sage 100 Contractor: what the shipped default templates set up
...
`dlake-txdownloaderpro-dynamicscrm/erps/sage-100-contractor.md`, and that skill’s ERP table is
what points at it.
