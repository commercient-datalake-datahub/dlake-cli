---
name: dlake-txdownloaderpro-dynamicscrm/erps/sage-300
description: >-
  What the shipped default TxDownloaderPro templates set up when Dynamics CRM is the writeback
  destination and Sage 300 is the source: the 1 default template the catalogue ships for this
...
# TxDownloaderPro ← Dynamics CRM — Sage 300: what the shipped default templates set up
...
`dlake-txdownloaderpro-dynamicscrm/erps/sage-300.md`, and that skill’s ERP table is what points
at it.
