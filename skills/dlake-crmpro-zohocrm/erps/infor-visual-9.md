...
description: >-
  What the shipped CRMPro templates set up for an Infor Visual 9 source pushing into Zoho CRM: the
  ...
  an Infor Visual 9 → Zoho CRM template set, when deciding which templates to import and activate,
