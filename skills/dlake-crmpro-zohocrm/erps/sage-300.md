...
description: >-
  What the shipped CRMPro templates set up for a Sage 300 source pushing into Zoho CRM: the
  ...
  reading a Sage 300 → Zoho CRM template set, when deciding which templates to import and
