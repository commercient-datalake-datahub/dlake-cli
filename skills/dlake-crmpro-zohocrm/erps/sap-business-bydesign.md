---
name: dlake-crmpro-zohocrm/erps/sap-business-bydesign
description: >-
  What the CRMPro template catalogue carries for a SAP Business ByDesign source pushing into Zoho
  ...
  destination objects they write are `Accounts`,
  `commercientsapbusinessbydesign__SAP_Business_Customer`, `Contacts`, `Products`. Use it when
  deciding whether a shipped template set exists for a SAP Business ByDesign → Zoho CRM before
...
# CRMPro → Zoho CRM — SAP Business ByDesign: what the template catalogue carries
...
source's own templates set. This page is `dlake-crmpro-zohocrm/erps/sap-business-bydesign.md`, and
...
- Destination objects: `Accounts`, `commercientsapbusinessbydesign__SAP_Business_Customer`, `Contacts`, `Products` and 7 custom objects
- Object display names: Account, Contacts, Products and 8 further templates
...
adds what the SAP Business ByDesign → Zoho CRM template catalogue carries. `dlake-crmpro-zohocrm`
