...
description: >-
  What the shipped CRMPro templates set up for a SYSPRO 7 and above source pushing into Zoho CRM:
  ...
  up or reading a SYSPRO 7 and above → Zoho CRM template set, when deciding which templates to
