---
name: dlake-crmpro-zohocrm/erps/sage-100-us
description: >-
  What the shipped CRMPro templates set up for a Sage 100 (US) source pushing into Zoho CRM: the
  ...
  Item Master, Quotes and more. Use it when standing up or reading a Sage 100 (US) → Zoho CRM
...
source's own templates set. This page is `dlake-crmpro-zohocrm/erps/sage-100-us.md`, and that
skill's ERP table is what points at it. What follows is only what the shipped Sage 100 (US) → Zoho
...
adds what the shipped Sage 100 (US) → Zoho CRM templates set up. `dlake-crmpro-zohocrm` is the
