---
name: dlake-crmpro-zohocrm/erps/epicor-9-and-9-5
description: >-
  What the CRMPro template catalogue carries for an Epicor 9 and 9.5 source pushing into Zoho CRM:
  no Standard template ships for this pair, and the 4 community templates it does carry are stated
  ...
  they write are `Accounts`, `Contacts`, `Products`. Use it when deciding whether a shipped
  template set exists for an Epicor 9 and 9.5 → Zoho CRM before standing one up, and what the
...
# CRMPro → Zoho CRM — Epicor 9 and 9.5: what the template catalogue carries
...
source's own templates set. This page is `dlake-crmpro-zohocrm/erps/epicor-9-and-9-5.md`, and that
...
- Destination objects: `Accounts`, `Contacts`, `Products`
- Object display names: Accounts, Contacts, Products
...
adds what the Epicor 9 and 9.5 → Zoho CRM template catalogue carries. `dlake-crmpro-zohocrm` is
