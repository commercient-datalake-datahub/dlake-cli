...
description: >-
  What the shipped CRMPro templates set up for a NetSuite source pushing into Zoho CRM: the
  ...
  Product, Netsuite Item and more. Use it when standing up or reading a NetSuite → Zoho CRM
