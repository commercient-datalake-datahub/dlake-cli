...
# TxDownloaderPro ← Shopify — Acumatica Cloud: what the shipped default templates set up
...
`dlake-txdownloaderpro-shopify/erps/acumatica-cloud.md`, and that skill’s ERP table is what
points at it.
