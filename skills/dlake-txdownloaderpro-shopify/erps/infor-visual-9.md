---
name: dlake-txdownloaderpro-shopify/erps/infor-visual-9
description: >-
...
# TxDownloaderPro ← Shopify — Infor Visual 9: what the shipped default templates set up
...
`dlake-txdownloaderpro-shopify/erps/infor-visual-9.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| Create Contact | Shopify Customer to INFORVISUAL9 Contact | `Customer` → `CONTACT` | 1 | create |
| Create Customer | Shopify Customer to INFORVISUAL9 Customer | `Customer` → `Customer` | 1 | create |
