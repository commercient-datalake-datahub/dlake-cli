...
description: >-
  ...
  destination and Infor Visual 9 is the source: the 1 default template the catalogue ships for
...
The field-process versions this pair’s default templates belong to: `TxDownloaderPro_38_1`.
