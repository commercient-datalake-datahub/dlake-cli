...
# TxDownloaderPro ← Shopify — Sage 50 UK: what the shipped default templates set up
...
`dlake-txdownloaderpro-shopify/erps/sage-50-uk.md`, and that skill’s ERP table is what points at
it.
...
- **`Line.` section members present:** `Line.DESCRIPTION`, `Line.QTY_ORDER`, `Line.STOCK_CODE`,
  `Line.UNIT_PRICE`, `Line.mainXml`, `Line.StockCodeSearchFieldName`. 2 templates name the
