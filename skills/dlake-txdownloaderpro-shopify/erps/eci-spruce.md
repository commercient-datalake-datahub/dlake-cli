---
name: dlake-txdownloaderpro-shopify/erps/eci-spruce
description: >-
  The catalogue ships no default TxDownloaderPro template for the pair where Shopify is the
  writeback destination and ECi Spruce is the source. It does carry 3 community templates for
  the pair, across 3 field-process versions, and this page lists them: how many there are, which
...
# TxDownloaderPro ← Shopify — ECi Spruce: no default templates, and the community set the catalogue carries
...
`dlake-txdownloaderpro-shopify/erps/eci-spruce.md`, and that skill’s ERP table is what points at
it.
...
- **How many:** 3 community templates, across 3 field-process versions.
- **Operations:** 3 carry `IsInsert`, 0 carry `IsUpdate`, 0 carry `IsDelete`. A flag decides
...
- **Template names the catalogue carries:** `Create New Account` (1), `Create New Payment` (1),
  `Create New Sales Order` (1).
- **Field-process versions they belong to:** `TxDownloaderPro_155_1`, `TxDownloaderPro_155_2`,
  `TxDownloaderPro_155_3`.
