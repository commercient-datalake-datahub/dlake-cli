---
name: dlake-txdownloaderpro-dynamiccrm
description: >-
  ...
  `dlake-txdownloaderpro-<erp>-dynamiccrm` carry each ERP's own default template set.
---
...
those ERPs has its own page, `dlake-txdownloaderpro-<erp>-dynamiccrm`. The catalogue spells this
...
- `dlake-txdownloaderpro-<erp>-dynamiccrm` — one page per ERP that ships default templates for
  this destination.
