...
source's own templates set. This page is `dlake-crmpro-shopify/erps/sage-intacct.md`, and that
skill's ERP table is what points at it. What follows is only what the shipped Sage Intacct →
...
adds what the shipped Sage Intacct → Shopify templates set up. `dlake-crmpro-shopify` is the
