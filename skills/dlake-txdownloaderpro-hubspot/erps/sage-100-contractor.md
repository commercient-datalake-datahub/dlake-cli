...
description: >-
  ...
  destination and Sage 100 Contractor is the source: the 6 default templates the catalogue ships
...
- **Objects read:** `contacts`, `companies`.
...
and are counted but not described. A parseable document carries about 14 members.

- **Template path roots used:** `contacts`, `companies`, `ontacts`, `arcustomercode`. A path’s
