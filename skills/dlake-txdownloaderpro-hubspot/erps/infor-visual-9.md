---
name: dlake-txdownloaderpro-hubspot/erps/infor-visual-9
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and Infor Visual 9 is the source: the 2 default templates the catalogue ships for
...
# TxDownloaderPro ← HubSpot — Infor Visual 9: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/infor-visual-9.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| Create Contact | HubSpot contacts to Infor VISUAL 9 Contact | `contacts` → `CONTACT` | 1 | create |
| Create Customer | HubSpot companies to Infor VISUAL 9 Customer | `companies` → `Customer` | 1 | create |
...
The field-process versions this pair’s default templates belong to: `TxDownloaderPro_38_2`,
`TxDownloaderPro_38_1`.
