---
name: dlake-txdownloaderpro-hubspot/erps/aptean-ross
description: >-
  The catalogue ships no default TxDownloaderPro template for the pair where HubSpot is the
  writeback destination and Aptean Ross is the source. It does carry 1 community template for
...
# TxDownloaderPro ← HubSpot — Aptean Ross: no default templates, and the community set the catalogue carries
...
`dlake-txdownloaderpro-hubspot/erps/aptean-ross.md`, and that skill’s ERP table is what points
at it.
...
- **Template names the catalogue carries:** `Create New Customer` (1).
- **Field-process versions they belong to:** `TxDownloaderPro_141_1`.
