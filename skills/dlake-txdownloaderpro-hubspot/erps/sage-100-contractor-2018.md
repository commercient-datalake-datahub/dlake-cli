---
name: dlake-txdownloaderpro-hubspot/erps/sage-100-contractor-2018
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and Sage 100 Contractor 2018 is the source: the 6 default templates the catalogue
...
# TxDownloaderPro ← HubSpot — Sage 100 Contractor 2018: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/sage-100-contractor-2018.md`, and that skill’s ERP table is
what points at it.
...
|---|---|---|---|---|
| Create/Update Contact | Hubspot Contacts to Sage100 Contractor ClientContact | `contacts` → `ClientContact`, `JobContact` | 4 | create / update |
| Create/Update Customer | Hubspot companies To Sage100 Contractor Customer | `companies` → `Customer` | 2 | create / update |
