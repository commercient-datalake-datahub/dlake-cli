...
# TxDownloaderPro ← HubSpot — Sage 50 US: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/sage-50-us.md`, and that skill’s ERP table is what points at
it.
...
- **How many:** 10 community templates, across 6 field-process versions.
- **Operations:** 7 carry `IsInsert`, 3 carry `IsUpdate`, 0 carry `IsDelete`. A flag decides
...
- **Template names the catalogue carries:** `Create New Customer` (3), `Create New Contact` (1),
  `Create Sales Order` (1), `Update Customer` (1).
...
- **Field-process versions they belong to:** `TxDownloader_1_27`, `TxDownloader_1_1`,
  `TxDownloader_1_3`, `TxDownloader_1_2`, `TxDownloader_1_12`, `TxDownloader_1_13`.
