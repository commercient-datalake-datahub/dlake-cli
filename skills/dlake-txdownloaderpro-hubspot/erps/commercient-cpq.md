---
name: dlake-txdownloaderpro-hubspot/erps/commercient-cpq
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and Commercient CPQ is the source: the 2 default templates the catalogue ships for
...
# TxDownloaderPro ← HubSpot — Commercient CPQ: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/commercient-cpq.md`, and that skill’s ERP table is what
points at it.
...
The field-process versions this pair’s default templates belong to: `TxDownloader_26_2`,
`TxDownloader_26_3`.
...
- **Template path roots used:** `LineItem`, `deals`, `products`. A path’s first segment has to
