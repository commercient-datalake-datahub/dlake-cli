---
name: dlake-txdownloaderpro-hubspot/erps/macola-es
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and Macola ES is the source: the 1 default template the catalogue ships for this
...
# TxDownloaderPro ← HubSpot — Macola ES: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/macola-es.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| Create New Customer | HubSpot companies to Macola ES Customer | `companies` → `Customer` | 1 | create |
