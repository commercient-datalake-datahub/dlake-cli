---
name: dlake-txdownloaderpro-hubspot/erps/aptean-encompix
description: >-
...
# TxDownloaderPro ← HubSpot — Aptean Encompix: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/aptean-encompix.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| TxDownloaderPro_144_1_1 | HubSpot deals to Aptean Encompix Quote | `deals` → `Quote` | 1 | create |
...
- **Template path roots used:** `LineItem`, `deals`. A path’s first segment has to match the
