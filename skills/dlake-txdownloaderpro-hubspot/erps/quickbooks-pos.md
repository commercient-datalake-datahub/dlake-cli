---
name: dlake-txdownloaderpro-hubspot/erps/quickbooks-pos
description: >-
...
# TxDownloaderPro ← HubSpot — QuickBooks POS: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/quickbooks-pos.md`, and that skill’s ERP table is what
points at it.
...
- **Response fields it reads them from:** `ListID`. The map is written **source-path first,
