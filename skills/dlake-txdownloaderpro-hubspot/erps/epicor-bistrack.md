---
name: dlake-txdownloaderpro-hubspot/erps/epicor-bistrack
description: >-
...
# TxDownloaderPro ← HubSpot — Epicor BisTrack: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/epicor-bistrack.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| Create Customer | HubSpot companies to Epicor BisTrack Customer Bill To | `companies` → `CustomerBillTo` | 1 | create |
| Import Contact | HubSpot deals to Epicor BisTrack Sales Order | `deals` → `SalesOrder` | 1 | create |
