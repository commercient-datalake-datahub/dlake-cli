---
name: dlake-txdownloaderpro-hubspot/erps/exact-globe-next
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and Exact Globe Next is the source: the 4 default templates the catalogue ships
...
# TxDownloaderPro ← HubSpot — Exact Globe Next: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/exact-globe-next.md`, and that skill’s ERP table is what
points at it.
...
|---|---|---|---|---|
| TxDownloaderPro_129_1_1 | HubSpot companies to Exact Globe Next Customer | `companies` → `Customer` | 1 | create |
| TxDownloaderPro_129_2_1 | HubSpot contacts to Exact Globe Next Contact | `contacts` → `Contact` | 1 | create |
| TxDownloaderPro_129_3_1 | HubSpot deals to Exact Globe Next SalesOrder | `deals` → `SalesOrder` | 1 | create |
| TxDownloaderPro_129_4_1 | HubSpot products to Exact Globe Next Item | `products` → `Item` | 1 | create |
...
The field-process versions this pair’s default templates belong to: `TxDownloaderPro_129_1`,
`TxDownloaderPro_129_2`, `TxDownloaderPro_129_3`, `TxDownloaderPro_129_4`.
...
- **Objects read:** `companies`, `contacts`, `deals`, `products`.
...
- **Template path roots used:** `deals`, `contacts`, `companies`, `LineItem`, `products`. A
