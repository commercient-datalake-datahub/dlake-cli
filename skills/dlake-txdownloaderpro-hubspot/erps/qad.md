---
name: dlake-txdownloaderpro-hubspot/erps/qad
description: >-
...
# TxDownloaderPro ← HubSpot — QAD: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/qad.md`, and that skill’s ERP table is what points at it.
...
|---|---|---|---|---|
| Create Customer | HubSpot companies to QAD ERP Customer | `companies` → `Customer` | 1 | create |
| Create SalesOrder | HubSpot deals to QAD ERP Sales Order | `deals` → `SalesOrder` | 1 | create |
