...
description: >-
  ...
  fill for the write back to the CRM. It also lists the 6 community templates the catalogue
...
# TxDownloaderPro ← HubSpot — Sage 50 UK: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/sage-50-uk.md`, and that skill’s ERP table is what points at
it.
...
- **Template names the catalogue carries:** `New Sales Order` (3), `New Accounts` (2), `New
  Account` (1).
