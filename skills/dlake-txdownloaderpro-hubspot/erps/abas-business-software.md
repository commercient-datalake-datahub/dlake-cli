---
name: dlake-txdownloaderpro-hubspot/erps/abas-business-software
description: >-
...
# TxDownloaderPro ← HubSpot — Abas Business Software: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/abas-business-software.md`, and that skill’s ERP table is
what points at it.
...
|---|---|---|---|---|
| Create New Customer | HubSpot companies to ABASBusinessSoftware Customer | `companies` → `Customer` | 1 | create |
| Create New Customer Contact | HubSpot contacts to ABASBusinessSoftware Customer Contact | `contacts` → `CustomerContact` | 1 | create |
| Create New Prospect Contact | HubSpot contacts to ABASBusinessSoftware Prospect Contact | `contacts` → `ProspectContact` | 1 | create |
| Create New Prospects | HubSpot companies to ABASBusinessSoftware Prospect | `companies` → `Prospect` | 1 | create |
| Update Customer | HubSpot Update companies to ABASBusinessSoftware Update Customer | `companies` → `Customer` | 1 | update |
| Update Customer Contact | HubSpot Update contacts to ABASBusinessSoftware Update Customer Contact | `contacts` → `CustomerContact` | 1 | update |
| Update Prospect Contact | HubSpot Update contacts to ABASBusinessSoftware Update Prospect Contact | `contacts` → `ProspectContact` | 1 | update |
| Update Prospects | HubSpot Update companies to ABASBusinessSoftware Update Prospect | `companies` → `Prospect` | 1 | update |
...
- **Objects read:** `companies`, `contacts`.
...
- **Template path roots used:** `contacts`, `companies`. A path’s first segment has to match the
