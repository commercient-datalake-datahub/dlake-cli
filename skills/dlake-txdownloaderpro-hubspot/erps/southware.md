---
name: dlake-txdownloaderpro-hubspot/erps/southware
description: >-
...
# TxDownloaderPro ← HubSpot — SouthWare: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/southware.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| Create New Customer | HubSpot companies to SouthWare Customer | `companies` → `Customer` | 1 | create |
| Create New SalesOrder | HubSpot deals to SouthWare Sales Order | `deals` → `SalesOrder` | 1 | create |
