...
description: >-
  ...
  destination and Sage X3 is the source: the 1 default template the catalogue ships for this
...
`dlake-txdownloaderpro-hubspot/erps/sage-x3.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| CreateCustomer | HubSpot companies to Sage X3 Customer | `companies` → `Customer` | 1 | create |
...
The field-process versions this pair’s default templates belong to: `TxDownloader_23_1`.
