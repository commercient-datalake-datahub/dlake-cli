---
name: dlake-txdownloaderpro-hubspot/erps/eci-spruce
description: >-
...
# TxDownloaderPro ← HubSpot — ECi Spruce: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/eci-spruce.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| Create New Account | HubSpot companies to ECI Spruce Account | `companies` → `Account` | 1 | create |
| Create New Orders | HubSpot deals to ECI Spruce Sales Order | `deals` → `Sales Order` | 1 | create |
