---
name: dlake-txdownloaderpro-hubspot/erps/sage-200-uk
description: >-
...
# TxDownloaderPro ← HubSpot — Sage 200 UK: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/sage-200-uk.md`, and that skill’s ERP table is what points
at it.
...
|---|---|---|---|---|
| Create/Update Customer | HubSpot companies to Sage 200 UK Customer | `companies` → `Customer` | 2 | create / update |
| Create Contact | HubSpot contacts to Sage 200 UK Contact | `contacts` → `Contact` | 1 | create |
| TxDownloaderPro_28_2 | HubSpot deals to Sage 200 UK Sales Order | `deals` → `Sales Order` | 1 | create |
