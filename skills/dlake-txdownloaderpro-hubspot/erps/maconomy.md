---
name: dlake-txdownloaderpro-hubspot/erps/maconomy
description: >-
...
# TxDownloaderPro ← HubSpot — Maconomy: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/maconomy.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| Create Customer | HubSpot companies to Maconomy Customer | `companies` → `Customer` | 2 | create / update |
| Create Job | HubSpot deals to Maconomy Job | `deals` → `Job` | 2 | create / update |
...
- **Template path roots used:** `companies`, `deals`. A path’s first segment has to match the
