---
name: dlake-txdownloaderpro-hubspot/erps/globalshop
description: >-
...
# TxDownloaderPro ← HubSpot — GlobalShop: what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot/erps/globalshop.md`, and that skill’s ERP table is what points at
it.
...
|---|---|---|---|---|
| Create New Contact | HubSpot contacts to GlobalShop Contact | `contacts` → `Contact` | 2 | create / update |
| Create New Customer | HubSpot companies to GlobalShop Customer | `companies` → `Customer` | 2 | create / update |
| Create New Sales Order | HubSpot deals to GlobalShop Sales Order | `deals` → `Sales Order` | 1 | create |
