...
source's own templates set. This page is `dlake-crmpro-hubspot/erps/hubspot.md`, and that skill's
ERP table is what points at it. What follows is only what the shipped HubSpot → HubSpot templates
