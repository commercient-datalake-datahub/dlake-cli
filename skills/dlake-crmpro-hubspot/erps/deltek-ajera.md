---
name: dlake-crmpro-hubspot/erps/deltek-ajera
description: >-
...
source's own templates set. This page is `dlake-crmpro-hubspot/erps/deltek-ajera.md`, and that
skill's ERP table is what points at it. What follows is only what the shipped Deltek Ajera →
...
- Object display names: upsert company, upsert contact, upsert deal
