---
name: dlake-crmpro-hubspot/erps/datacor-chempax
description: >-
  ...
  outcome of each template group — create contact. Use it when standing up or reading a Datacor
  Chempax → HubSpot template set, when deciding which templates to import and activate, or when a
...
source's own templates set. This page is `dlake-crmpro-hubspot/erps/datacor-chempax.md`, and that
skill's ERP table is what points at it. What follows is only what the shipped Datacor Chempax →
