---
name: dlake-txdownloaderpro-quickbookpos-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and QUICKBOOKSPOS is the source: the 1 default template the catalogue ships for
...
# TxDownloaderPro ← Salesforce (QUICKBOOKSPOS): what the shipped default templates set up
