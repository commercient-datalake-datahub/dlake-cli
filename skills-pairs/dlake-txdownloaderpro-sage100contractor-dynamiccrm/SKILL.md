---
name: dlake-txdownloaderpro-sage100contractor-dynamiccrm
description: >-
  What the shipped default TxDownloaderPro templates set up when Dynamics CRM is the writeback
  destination and SAGE100CONTRACTOR is the source: the 4 default templates the catalogue ships
...
# TxDownloaderPro ← Dynamics CRM (SAGE100CONTRACTOR): what the shipped default templates set up
...
The field-process versions this pair’s default templates belong to: `TxDownloaderPro_34_1`,
