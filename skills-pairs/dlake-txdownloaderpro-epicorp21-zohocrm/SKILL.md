---
name: dlake-txdownloaderpro-epicorp21-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and EPICOR P21(PROPHET 21) is the source: the 4 default templates the catalogue
...
# TxDownloaderPro ← ZOHO CRM (EPICOR P21(PROPHET 21)): what the shipped default templates set up
