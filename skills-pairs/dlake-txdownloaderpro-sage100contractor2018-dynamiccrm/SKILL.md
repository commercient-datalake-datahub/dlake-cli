---
name: dlake-txdownloaderpro-sage100contractor2018-dynamiccrm
description: >-
  What the shipped default TxDownloaderPro templates set up when Dynamics CRM is the writeback
  destination and SAGE100CONTRACTOR2018 is the source: the 4 default templates the catalogue
...
# TxDownloaderPro ← Dynamics CRM (SAGE100CONTRACTOR2018): what the shipped default templates set up
