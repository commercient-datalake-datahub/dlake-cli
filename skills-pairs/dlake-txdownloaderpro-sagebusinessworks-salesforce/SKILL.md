---
name: dlake-txdownloaderpro-sagebusinessworks-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and SAGE BUSINESS WORKS 2013/2015 is the source: the 1 default template the
...
# TxDownloaderPro ← Salesforce (SAGE BUSINESS WORKS 2013/2015): what the shipped default templates set up
