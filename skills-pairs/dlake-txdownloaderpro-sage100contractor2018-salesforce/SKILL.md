---
name: dlake-txdownloaderpro-sage100contractor2018-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and SAGE100CONTRACTOR2018 is the source: the 8 default templates the catalogue
...
# TxDownloaderPro ← Salesforce (SAGE100CONTRACTOR2018): what the shipped default templates set up
