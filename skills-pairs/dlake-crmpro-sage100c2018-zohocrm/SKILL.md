---
name: dlake-crmpro-sage100c2018-zohocrm
description: >-
  What the shipped CRMPro templates set up for a SAGE100C2018 source pushing into ZohoCRM: the
  `CRM_Configuration` row each template inserts (object API names
  `sage100premium__Ar_SalesPerson`, `Accounts`, `sage100premium__CI_Iem`,
  `sage100premium__SO_ShipToAddress`, `Products`, `Contacts` and the rest, the match key,
  ...
  outcome of each template group — Sage100 Sales Person, Account, Sage100 Customer, Sage100 Ship
  To Address, Products, Contacts, Sage100 Item Master, Quotes and more. Use it when standing up or
  reading a SAGE100C2018 → ZohoCRM template set, when deciding which templates to import and
...
# CRMPro → ZohoCRM (SAGE100C2018): what the shipped templates set up
...
What follows is only what the shipped SAGE100C2018 → ZohoCRM templates themselves set, read from
...
| **Products** | The templates push `Products` to ZohoCRM. | `Products` | `SF_ERP_Salesforce_Clone_CI_ITEM` |
| **Contacts** | The templates push `Contacts` to ZohoCRM. | `Contacts` | — |
...
| **Quotes** | The templates push `Quotes` to ZohoCRM. | `Quotes` | `SF_ERP_Salesforce_Clone_SO_SALESORDERDETAIL`, `SF_ERP_Salesforce_Clone_CI_ITEM`, `SF_ERP_Salesforce_Clone_SO_SALESORDERHEADER`, `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS`, `x` |
...
| **PriceBooks** | The templates push `Price_Books` to ZohoCRM. | `Price_Books` | `SF_ERP_Salesforce_Clone_CI_ITEM` |
...
| **Sales Orders** | The templates push `Sales_Orders` to ZohoCRM. | `Sales_Orders` | `SF_ERP_Salesforce_Clone_SO_SALESORDERDETAIL`, `SF_ERP_Salesforce_Clone_CI_ITEM`, `SF_ERP_Salesforce_Clone_SO_SALESORDERHEADER`, `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS`, `x` |
| **Invoices** | The templates push `Invoices` to ZohoCRM. | `Invoices` | `SF_ERP_Salesforce_Clone_AR_INVOICEHISTORYDETAIL`, `SF_ERP_Salesforce_Clone_CI_ITEM`, `SF_ERP_Salesforce_Clone_AR_INVOICEHISTORYHEADER`, `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS`, `x` |
...
|---|---|---|---|---|---|---|
| Sage100 Sales Person | `sage100premium__Ar_SalesPerson` | `Commercient_ExternalKey` | 1 | `vw_SAGE100_AR_SALESPERSON:` | `vw_SAGE100_AR_SALESPERSON` | `sage100premium__` / `__c` |
| Users | `users` | `Commercient_ExternalKey` | 1 | `vw_Users:` | `SELECT 1` | `''` / `''` |
| Account | `Accounts` | `Commercient_ArCustomer_Code` | 2 | `vw_SAGE100_Account:` | `vw_SAGE100_Account` | `''` / `''` |
| Sage100 Customer | `sage100premium__CI_Iem` | `Commercient_ExternalKey` | 3 | `vw_SAGE100_Customer:` | `vw_SAGE100_Customer` | `sage100premium__` / `__c` |
| Sage100 Ship To Address | `sage100premium__SO_ShipToAddress` | `Commercient_ExternalKey` | 4 | `vw_SAGE100_ShipToAddress:` | `vw_SAGE100_ShipToAddress` | `sage100premium__` / `__c` |
...
| PriceBooks | `Price_Books` | `Commercient_ExternalKey` | 15 | `vw_Pricebooks:` | `vw_SAGE100_Standard_Pricebooks` | `''` / `''` |
| Sage100 Product Price Book | `Products:Price_Books` | `Commercient_ExternalKey` | 16 | `vw_ProductPriceBook:` | `vw_SAGE100_ProductPriceBook` | `''` / `''` |
| Sales Orders | `Sales_Orders` | `Commercient_ExternalKey` | 17 | `vw_SAGE100_DSalesOrder:` | `vw_SAGE100_DSalesOrder` | `''` / `''` |
| Invoices | `Invoices` | `Commercient_ExternalKey` | 18 | `vw_SAGE100_DInvoice:` | `vw_SAGE100_DInvoice` | `''` / `''` |
...
| `vw_SAGE100_Account` | insert + update | — | `vw_SAGE100_AR_SALESPERSON:`, `vw_Users:`, `vw_SAGE100_Account:` | `Commercient_ArCustomer_Code` | `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS` |
...
| `vw_SAGE100_Product` | insert-only | — | `vw_SAGE100_Product:` | `Commercient_ExternalKey` | `SF_ERP_Salesforce_Clone_CI_ITEM` |
...
| `vw_SAGE100_Quotes` | insert-only | — | `vw_SAGE100_Product:`, `vw_SAGE100_Account:`, `vw_SAGE100_AR_SALESPERSON:`, `vw_SAGE100_Quotes:` | `ExternalKey`, `Commercient_ExternalKey__c`, `Commercient_ExternalKey` | `SF_ERP_Salesforce_Clone_SO_SALESORDERDETAIL`, `SF_ERP_Salesforce_Clone_CI_ITEM`, `SF_ERP_Salesforce_Clone_SO_SALESORDERHEADER`, `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS` |
...
| `vw_SAGE100_Standard_Pricebooks` | insert + update | — | `vw_Pricebooks:` | `Commercient_ExternalKey__c`, `Commercient_ExternalKey` | `SF_ERP_Salesforce_Clone_CI_ITEM` |
...
| `vw_SAGE100_DSalesOrder` | insert-only | — | `vw_SAGE100_Product:`, `vw_SAGE100_Account:`, `vw_SAGE100_DSalesOrder:` | `ExternalKey`, `Commercient_ExternalKey__c`, `Commercient_ExternalKey` | `SF_ERP_Salesforce_Clone_SO_SALESORDERDETAIL`, `SF_ERP_Salesforce_Clone_CI_ITEM`, `SF_ERP_Salesforce_Clone_SO_SALESORDERHEADER`, `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS` |
| `vw_SAGE100_DInvoice` | insert-only | — | `vw_SAGE100_Product:`, `vw_SAGE100_Account:`, `vw_SAGE100_DSalesOrder:`, `vw_SAGE100_DInvoice:` | `ExternalKey`, `Commercient_ExternalKey__c`, `Commercient_ExternalKey` | `SF_ERP_Salesforce_Clone_AR_INVOICEHISTORYDETAIL`, `SF_ERP_Salesforce_Clone_CI_ITEM`, `SF_ERP_Salesforce_Clone_AR_INVOICEHISTORYHEADER`, `SF_ERP_Salesforce_Clone_AR_CUSTOMER`, `SF_ERP_Salesforce_Clone_SO_SHIPTOADDRESS` |
...
- `1` — Sage100 Sales Person, Users
- `2` — Account
- `3` — Sage100 Customer
- `4` — Sage100 Ship To Address
- `5` — Products
- `6` — Contacts
...
- `vw_SAGE100_Account` reads `vw_SAGE100_AR_SALESPERSON:`, `vw_Users:`, `vw_SAGE100_Account:`; no template in this set writes `vw_SAGE100_AR_SALESPERSON:`, `vw_Users:`, `vw_SAGE100_Account:`
...
- `vw_SAGE100_Standard_Pricebooks` reads `vw_Pricebooks:`; no template in this set writes `vw_Pricebooks:`
...
| Users | `users` | 1 | `ExternalKey` → `Commercient_ExternalKey` |
...
| Sage100 Customer | `sage100premium__CI_Iem` | 78 | `ARDIVISIONNO, CUSTOMERNO` → `ExternalKey`, `ARDIVISIONNO, CUSTOMERNO` → `Commercient_ExternalKey__c`, `ARDIVISIONNO` → `AR_Division_No`, `ADDRESSLINE1` → `Address_Line1`, `ADDRESSLINE2` → `Address_Line2` |
...
| Contacts | `Contacts` | 5 | `ExternalKey` → `Commercient_ExternalKey`, `FirstName` → `FirstName`, `LastName` → `LastName`, `Email` → `Email`, `Phone` → `Phone` |
...
| Quotes | `Quotes` | 18 | `ARDIVISIONNO,SALESORDERNO` → `Commercient_ExternalKey__c`, `SFDCID` → `Account_Name`, `SALESORDERNO` → `Name`, `SALESORDERNO` → `Quote_Number`, `DATECREATED` → `ERP_Created_Date__c` |
| Sage100 Sales Order Header | `sage100premium__SO_SalesOrdrHistoryHeader` | 82 | `SALESORDERNO` → `Commercient_ExternalKey__c`, `SALESORDERNO` → `Name`, `ARDIVISIONNO` → `Area_Division_No_Key`, `BATCHEMAIL` → `Batch_Email`, `BATCHFAX` → `Batch_Fax` |
...
| Sage100 Invoice Header | `sage100premium__Ar_InvoiceHistoryHeader` | 89 | `INVOICENO, HEADERSEQNO` → `Commercient_ExternalKey__c`, `INVOICENO, HEADERSEQNO` → `Name`, `ARDIVISIONNO` → `AR_Division_No__c`, `AMOUNTSUBJECTTODISCOUNT` → `Amount_Subject_To_Discount__c`, `APPLYTOINVOICENO` → `Apply_To_Invoice_No__c` |
| Sage100 Invoice Detail | `sage100premium__Ar_InvoiceHistoryDetail` | 62 | `INVOICENO, HEADERSEQNO, DETAILSEQNO` → `Commercient_ExternalKey__c`, `INVOICENO, HEADERSEQNO, DETAILSEQNO` → `Name`, `APDIVISIONNO` → `AP_Division_No__c`, `ALIASITEMNO` → `Alias_Item_No__c`, `ALTERNATETAXIDENTIFIER` → `Alternate_Tax_Identifier__c` |
...
| Sage100 Warehouse | `sage100premium__LM_Item_Warehouse` | 30 | `ITEMCODE, WAREHOUSECODE` → `Commercient_ExternalKey__c`, `ITEMCODE, WAREHOUSECODE` → `Name`, `AVERAGECOST` → `Average_Cost__c`, `BINLOCATION` → `Bin_Location__c`, `COSTCALCCOSTCOMMITTED` → `Cost_Calc_Cost_Committed__c` |
| PriceBooks | `Price_Books` | 4 | `Commercient_ExternalKey__c` → `Commercient_ExternalKey__c`, `Price_Book_Name` → `Price_Book_Name`, `Active` → `Active`, `Description` → `Description` |
...
| Sales Orders | `Sales_Orders` | 18 | `ARDIVISIONNO,SALESORDERNO` → `Commercient_ExternalKey__c`, `SFDCID` → `Account_Name`, `SALESORDERNO` → `Name`, `SALESORDERNO` → `SO_Number`, `DATECREATED` → `ERP_Created_Date__c` |
| Invoices | `Invoices` | 20 | `ARDIVISIONNO,INVOICENO` → `Commercient_ExternalKey__c`, `SFDCID` → `Account_Name`, `SALESORDERNO` → `Sales_Order`, `INVOICENO` → `Name`, `INVOICENO` → `Invoice_Number` |
...
adds what the shipped SAGE100C2018 → ZohoCRM templates set up. `dlake-crmpro-hubspot`,
