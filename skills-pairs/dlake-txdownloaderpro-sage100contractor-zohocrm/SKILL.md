---
name: dlake-txdownloaderpro-sage100contractor-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and SAGE100CONTRACTOR is the source: the 10 default templates the catalogue ships
...
# TxDownloaderPro ← ZOHO CRM (SAGE100CONTRACTOR): what the shipped default templates set up
