---
name: dlake-txdownloaderpro-macolaes-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and MACOLAES is the source: the 2 default templates the catalogue ships for this
...
# TxDownloaderPro ← Salesforce (MACOLAES): what the shipped default templates set up
