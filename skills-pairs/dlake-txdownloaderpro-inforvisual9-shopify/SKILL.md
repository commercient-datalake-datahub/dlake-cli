---
name: dlake-txdownloaderpro-inforvisual9-shopify
description: >-
  What the shipped default TxDownloaderPro templates set up when Shopify is the writeback
  destination and INFORVISUAL9 is the source: the 1 default template the catalogue ships for
...
# TxDownloaderPro ← Shopify (INFORVISUAL9): what the shipped default templates set up
