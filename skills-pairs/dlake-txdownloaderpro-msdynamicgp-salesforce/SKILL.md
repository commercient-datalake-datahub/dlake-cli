---
name: dlake-txdownloaderpro-msdynamicgp-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and MSDynamicGP is the source: the 7 default templates the catalogue ships for
...
# TxDownloaderPro ← Salesforce (MSDynamicGP): what the shipped default templates set up
