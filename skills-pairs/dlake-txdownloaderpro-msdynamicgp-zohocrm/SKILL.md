---
name: dlake-txdownloaderpro-msdynamicgp-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and MSDynamicGP is the source: the 2 default templates the catalogue ships for
...
# TxDownloaderPro ← ZOHO CRM (MSDynamicGP): what the shipped default templates set up
