---
name: dlake-crmpro-sage100-salesforce
description: >-
  What the shipped CRMPro templates set up for a SAGE 100 ERP US source pushing into Salesforce:
  ...
  Ship Addresses, Product, Invoice History Headers and more. Use it when standing up or reading a
  SAGE 100 ERP US → Salesforce template set, when deciding which templates to import and activate,
...
# CRMPro → Salesforce (SAGE 100 ERP US): what the shipped templates set up
...
shipped SAGE 100 ERP US → Salesforce templates themselves set, read from their `Insert_Query`,
...
adds what the shipped SAGE 100 ERP US → Salesforce templates set up.
