---
name: dlake-txdownloaderpro-msdynamicnav-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and MS DYNAMIC NAV is the source: the 6 default templates the catalogue ships for
...
# TxDownloaderPro ← Salesforce (MS DYNAMIC NAV): what the shipped default templates set up
