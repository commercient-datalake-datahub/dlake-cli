---
name: dlake-txdownloaderpro-quickbook-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and QUICKBOOKS is the source: the 32 default templates the catalogue ships for
...
# TxDownloaderPro ← Salesforce (QUICKBOOKS): what the shipped default templates set up
