---
name: dlake-txdownloaderpro-msdynamicgp-shopify
description: >-
  What the shipped default TxDownloaderPro templates set up when Shopify is the writeback
  destination and MSDynamicGP is the source: the 3 default templates the catalogue ships for
...
# TxDownloaderPro ← Shopify (MSDynamicGP): what the shipped default templates set up
