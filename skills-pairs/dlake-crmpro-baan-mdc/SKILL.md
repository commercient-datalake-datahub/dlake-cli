...
What follows is only what the shipped BAAN → MDC templates themselves set, read from their
...
adds what the shipped BAAN → MDC templates set up. `dlake-crmpro-hubspot`,
