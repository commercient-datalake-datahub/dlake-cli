---
name: dlake-txdownloaderpro-epicor9-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and EPICOR 9, EPICOR 9.5 is the source: the 2 default templates the catalogue
...
# TxDownloaderPro ← ZOHO CRM (EPICOR 9, EPICOR 9.5): what the shipped default templates set up
