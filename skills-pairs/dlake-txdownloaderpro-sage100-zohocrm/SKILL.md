---
name: dlake-txdownloaderpro-sage100-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and SAGE 100 ERP US is the source: the 10 default templates the catalogue ships
  for this pair, the 8 field-process versions they are identified by, what each template family
...
# TxDownloaderPro ← ZOHO CRM (SAGE 100 ERP US): what the shipped default templates set up
