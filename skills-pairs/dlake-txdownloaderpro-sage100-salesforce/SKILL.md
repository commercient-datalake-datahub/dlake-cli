---
name: dlake-txdownloaderpro-sage100-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and SAGE 100 ERP US is the source: the 32 default templates the catalogue ships
  for this pair, the 11 field-process versions they are identified by, what each template family
...
# TxDownloaderPro ← Salesforce (SAGE 100 ERP US): what the shipped default templates set up
