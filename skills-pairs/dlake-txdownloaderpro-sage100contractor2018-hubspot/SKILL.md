---
name: dlake-txdownloaderpro-sage100contractor2018-hubspot
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and SAGE100CONTRACTOR2018 is the source: the 6 default templates the catalogue
...
# TxDownloaderPro ← HubSpot (SAGE100CONTRACTOR2018): what the shipped default templates set up
