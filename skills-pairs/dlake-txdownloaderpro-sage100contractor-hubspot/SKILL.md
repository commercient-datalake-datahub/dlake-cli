---
name: dlake-txdownloaderpro-sage100contractor-hubspot
description: >-
  What the shipped default TxDownloaderPro templates set up when HubSpot is the writeback
  destination and SAGE100CONTRACTOR is the source: the 6 default templates the catalogue ships
  ...
  generally, and `dlake-txdownloaderpro-hubspot`, which carries the destination-side detail for
  HubSpot.
generated: true
---
...
# TxDownloaderPro ← HubSpot (SAGE100CONTRACTOR): what the shipped default templates set up
...
`dlake-txdownloaderpro-hubspot` is the HubSpot page and carries the destination-side detail;
...
- `dlake-txdownloaderpro-hubspot` — the HubSpot destination page: the query shape,
