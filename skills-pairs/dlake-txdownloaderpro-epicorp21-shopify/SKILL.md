---
name: dlake-txdownloaderpro-epicorp21-shopify
description: >-
  What the shipped default TxDownloaderPro templates set up when Shopify is the writeback
  destination and EPICOR P21(PROPHET 21) is the source: the 2 default templates the catalogue
...
# TxDownloaderPro ← Shopify (EPICOR P21(PROPHET 21)): what the shipped default templates set up
