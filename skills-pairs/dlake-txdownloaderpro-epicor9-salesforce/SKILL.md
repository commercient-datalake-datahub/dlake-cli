---
name: dlake-txdownloaderpro-epicor9-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and EPICOR 9, EPICOR 9.5 is the source: the 5 default templates the catalogue
...
# TxDownloaderPro ← Salesforce (EPICOR 9, EPICOR 9.5): what the shipped default templates set up
