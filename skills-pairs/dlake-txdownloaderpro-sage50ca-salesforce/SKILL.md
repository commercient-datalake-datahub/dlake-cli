---
name: dlake-txdownloaderpro-sage50ca-salesforce
description: >-
...
# TxDownloaderPro ← Salesforce (SAGE 50 CA): what the shipped default templates set up
...
|---|---|---|---|---|
| Create New Invoice | Salesforce Quote to Sage 50 CA Invoice Import | `Invoice`, `Order`, `Opportunity` → `Invoice` | 3 | create |
| Create New Quote | Salesforce Opportunity to Sage 50 CA Quote Import | `Opportunity`, `Quote`, `Order` → `Quote` | 3 | create |
| Create New SalesOrder | Salesforce Quote to Sage 50 CA Order Import | `Quote`, `Order`, `Opportunity` → `Order` | 3 | create |
