---
name: dlake-crmpro-sage1002017-mdc
description: >-
  What the shipped CRMPro templates set up for a SAGE1002017 source pushing into MDC: the
  ...
  SAGE1002017 Invoice and more. Use it when standing up or reading a SAGE1002017 → MDC template
...
# CRMPro → MDC (SAGE1002017): what the shipped templates set up
...
What follows is only what the shipped SAGE1002017 → MDC templates themselves set, read from their
...
adds what the shipped SAGE1002017 → MDC templates set up. `dlake-crmpro-hubspot`,
