---
name: dlake-txdownloaderpro-sage50ca-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and SAGE 50 CA is the source: the 2 default templates the catalogue ships for this
...
# TxDownloaderPro ← ZOHO CRM (SAGE 50 CA): what the shipped default templates set up
