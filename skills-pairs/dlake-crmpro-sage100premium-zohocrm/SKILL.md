---
name: dlake-crmpro-sage100premium-zohocrm
description: >-
  What the shipped CRMPro templates set up for a SAGE 100 PREMIUM source pushing into ZohoCRM: the
  ...
  Item Master, Quotes and more. Use it when standing up or reading a SAGE 100 PREMIUM → ZohoCRM
...
# CRMPro → ZohoCRM (SAGE 100 PREMIUM): what the shipped templates set up
...
What follows is only what the shipped SAGE 100 PREMIUM → ZohoCRM templates themselves set, read
...
adds what the shipped SAGE 100 PREMIUM → ZohoCRM templates set up. `dlake-crmpro-hubspot`,
