---
name: dlake-crmpro-msdynamicgp2016-salesforce
description: >-
  What the shipped CRMPro templates set up for a MS DYNAMIC GP 2016 source pushing into
  ...
  Account, Product, Invoice, Pricebook, Salesorder. Use it when standing up or reading a MS
  DYNAMIC GP 2016 → Salesforce template set, when deciding which templates to import and activate,
...
# CRMPro → Salesforce (MS DYNAMIC GP 2016): what the shipped templates set up
...
shipped MS DYNAMIC GP 2016 → Salesforce templates themselves set, read from their `Insert_Query`,
...
adds what the shipped MS DYNAMIC GP 2016 → Salesforce templates set up.
