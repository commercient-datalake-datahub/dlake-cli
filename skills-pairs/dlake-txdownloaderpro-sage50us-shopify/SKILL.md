---
name: dlake-txdownloaderpro-sage50us-shopify
description: >-
  ...
  generally, and `dlake-txdownloaderpro-shopify`, which carries the destination-side detail for
  Shopify.
generated: true
---
...
`dlake-txdownloaderpro-shopify` is the Shopify page and carries the destination-side detail;
...
- `dlake-txdownloaderpro-shopify` — the Shopify destination page: the query shape,
