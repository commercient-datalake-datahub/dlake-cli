---
name: dlake-txdownloaderpro-sage100-shopify
description: >-
  What the shipped default TxDownloaderPro templates set up when Shopify is the writeback
  destination and SAGE 100 ERP US is the source: the 4 default templates the catalogue ships for
...
# TxDownloaderPro ← Shopify (SAGE 100 ERP US): what the shipped default templates set up
