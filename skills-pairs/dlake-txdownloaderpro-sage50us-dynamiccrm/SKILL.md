---
name: dlake-txdownloaderpro-sage50us-dynamiccrm
description: >-
  ...
  generally, and `dlake-txdownloaderpro-dynamiccrm`, which carries the destination-side detail
  for Dynamics CRM.
generated: true
---
...
`dlake-txdownloaderpro-dynamiccrm` is the Dynamics CRM page and carries the destination-side
...
- `dlake-txdownloaderpro-dynamiccrm` — the Dynamics CRM destination page: the query shape,
