---
name: dlake-txdownloaderpro-sage100contractor2018-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and SAGE100CONTRACTOR2018 is the source: the 10 default templates the catalogue
...
# TxDownloaderPro ← ZOHO CRM (SAGE100CONTRACTOR2018): what the shipped default templates set up
