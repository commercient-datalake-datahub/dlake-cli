---
name: dlake-txdownloaderpro-inforsyteline-zohocrm
description: >-
  What the shipped default TxDownloaderPro templates set up when ZOHO CRM is the writeback
  destination and INFORSYTELINE is the source: the 3 default templates the catalogue ships for
...
# TxDownloaderPro ← ZOHO CRM (INFORSYTELINE): what the shipped default templates set up
