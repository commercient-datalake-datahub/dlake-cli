---
name: dlake-txdownloaderpro-inforsyteline-dynamiccrm
description: >-
  What the shipped default TxDownloaderPro templates set up when Dynamics CRM is the writeback
  destination and INFORSYTELINE is the source: the 2 default templates the catalogue ships for
...
# TxDownloaderPro ← Dynamics CRM (INFORSYTELINE): what the shipped default templates set up
...
here exactly as the rows spell it — `INFORSYTELINE` — and not by a display name.
