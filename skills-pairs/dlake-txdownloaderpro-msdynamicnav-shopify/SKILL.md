---
name: dlake-txdownloaderpro-msdynamicnav-shopify
description: >-
  What the shipped default TxDownloaderPro templates set up when Shopify is the writeback
  destination and MS DYNAMIC NAV is the source: the 2 default templates the catalogue ships for
...
# TxDownloaderPro ← Shopify (MS DYNAMIC NAV): what the shipped default templates set up
