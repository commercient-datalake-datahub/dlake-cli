---
name: dlake-txdownloaderpro-epicorp21-salesforce
description: >-
  What the shipped default TxDownloaderPro templates set up when Salesforce is the writeback
  destination and EPICOR P21(PROPHET 21) is the source: the 13 default templates the catalogue
...
# TxDownloaderPro ← Salesforce (EPICOR P21(PROPHET 21)): what the shipped default templates set up
